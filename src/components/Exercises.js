...
const Exercises = ({ exercises, setExercises, bodyPart }) => {
  ...
  const paginate = (event, value) => {  // Defining a paginate function for handling onchange event of Pagination.In case of complex components like pagination some additional information is also provided along with the event object.In case of pagination it also provides selected page number along with the event object.
